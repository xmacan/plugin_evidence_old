...
function plugin_evidence_initialize_database() {
	...
	api_plugin_db_table_create ('evidence', 'plugin_evidence_specific', $data);
	...
	db_execute ("INSERT INTO plugin_evidence_specific (org_id,description,oid,result,method,table_items,mandatory)
	...
	// Cisco - chassis
	db_execute ("INSERT INTO plugin_evidence_specific (org_id,description,oid,result,method,table_items) VALUES (9,'chassis','.1.3.6.1.4.1.9.5.1.2','.*','table','16-chassis_model,17-chassis_sn,19-chassis_sn_string')");
	db_execute ("INSERT INTO plugin_evidence_specific (org_id,description,oid,result,method,table_items) VALUES (9,'chassis','.1.3.6.1.4.1.9.3.6','.*','table','1-chassis_type,2-chassis_ver,3-chassis_id,5-chassis_romsysver')");
